...
import { acceptFriendRequest, getMyFriends, getMyNotifications, getMyProfile, login, logout, searchUser, sendFriendRequest, signup } from "../controllers/user.js";
...
// userRouter.get("/last-seen", getUserLastSeen);
